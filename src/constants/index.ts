...
export const CD_GIF_URL =
  'https://raw.githubusercontent.com/larahfelipe/saturn-bot/master/src/assets/cd.gif';

export const PROJECT_AUTHOR_URL = 'https://github.com/larahfelipe/';
export const PROJECT_REPOSITORY_URL = 'https://github.com/larahfelipe/saturn-bot/';
